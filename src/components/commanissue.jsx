...
export default function CommonProblems() {
  const categories = [
    ...
    { title: "Webcam Drivers", count: "Camera Guides", desc: "Camera input and video device information.", icon: <Video />, slug: "understand-webcam-driver-topics", image: "/images/support-agent.avif" },
    ...
    { title: "Chipset Info", count: "System Guides", desc: "Core system bridge and hardware communication.", icon: <Cpu />, slug: "guide-chipset-drivers", image: "/about/aboutmain_01.avif" },
    { title: "Touchpad Data", count: "Input Guides", desc: "Touchpad gestures and input recognition basics.", icon: <MousePointer2 />, slug: "understand-input-latency-drivers", image: "/images/choose-1.avif" },
    { title: "Storage Drives", count: "Drive Guides", desc: "SSD, HDD, and storage controller topics.", icon: <HardDrive />, slug: "understand-device-not-detected", image: "/images/choose-2.avif" },
    { title: "Keyboard Input", count: "Input Guides", desc: "Keyboard mapping and key input basics.", icon: <Keyboard />, slug: "understand-input-latency-drivers", image: "/images/choose-3.avif" },
