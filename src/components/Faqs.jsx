                    ...
                    {faqs.map((faq, i) => (
                        <div
                            ...
                            className={`border transition-all duration-300 rounded-2xl ${
                                active === i ? "border-blue-200 bg-blue-50/30" : "border-slate-100 bg-white hover:border-blue-100"
                            }`}
                        >
                            <button
                            ...
                            >
                                <span className={`text-[15px] md:text-[16px] font-semibold transition-colors duration-300 ${
                                    active === i ? "text-blue-600" : "text-[#07153A] group-hover:text-blue-600"
                                }`}>
                                    {faq.q}
                                </span>

                                <div className={`flex-shrink-0 ml-4 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${
                                    active === i ? "bg-blue-600 text-white rotate-180" : "bg-slate-50 text-slate-400 group-hover:bg-blue-50 group-hover:text-blue-600"
                                }`}>
