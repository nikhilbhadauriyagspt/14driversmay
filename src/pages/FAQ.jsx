...
const FAQPage = () => {
  ...
  const faqCategories = [
    {
      ...
      items: [
        {
          q: "What is Fanny Learn Hub?",
          a: "Fanny Learn Hub is an information-only educational resource. We provide documentation and guides to help users understand how hardware drivers work. We do NOT provide technical support, remote assistance, or repair services of any kind."
        },
        {
    ...
    },
    {
      ...
      items: [
        {
          q: "Is there a cost for using Fanny Learn Hub?",
  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen pt-28 pb-20 font-[Poppins]">
      <Helmet>
        <title>FAQ | Frequently Asked Questions | Fanny Learn Hub</title>
