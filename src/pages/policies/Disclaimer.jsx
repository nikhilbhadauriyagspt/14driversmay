...
const Disclaimer = () => {
  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-24">
      <Helmet>
        <title>Disclaimer - Charmliora</title>
        <meta name="description" content="Disclaimer for Charmliora." />
        <link rel="canonical" href="https://charmliora.co/disclaimer" />
      </Helmet>
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-lg text-gray-600">
          ...
          <p>The information provided by Charmliora ("we," "us," or "our") on <a href="https://charmliora.co">https://charmliora.co</a> (the "Site") is for general informational purposes only. All information on the Site is provided in good faith, however we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability or completeness of any information on the Site.</p>
