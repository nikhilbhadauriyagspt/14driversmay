...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-24 font-poppins">
      <Helmet>
        <title>Privacy Policy | Aura Learning Official Standards</title>
        <meta name="description" content="Detailed Privacy Policy for Aura Learning. Understand how we collect, use, and protect your technical data." />
      </Helmet>

      <div className="container mx-auto px-4 max-w-5xl">
        <h1 className="text-4xl md:text-5xl font-heading font-[500]text-gray-900 mb-4 uppercase">PRIVACY POLICY</h1>
        <p className="text-gray-500 mb-12 italic">Last updated Apr 30, 2026</p>

        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-8">
          <section>
            <p>
              This Privacy Notice for Aura Learning ("<strong>we</strong>," "<strong>us</strong>," or "<strong>our</strong>"), describes how and why we
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Visit our website at <a href="https://auralearning.co/" className="text-primary hover:text-secondary">https://auralearning.co/</a> or any website of ours that links to this Privacy Notice</li>
              <li>Use Aura Learning. At Aura Learning, we focus on technical accuracy and informational clarity. Our platform is built on providing documentation on how hardware drivers and device communication work. We serve the technical community with a commitment to maintaining accurate documentation.</li>
              <li>Engage with us in other related ways, including any marketing or events</li>
            </ul>
            <p>
              <strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:info@auralearning.co" className="text-primary">info@auralearning.co</a>.
            </p>
          </section>

          <section className="bg-gray-50 p-8 rounded-3xl border border-gray-100">
            <h2 className="text-2xl font-[500]text-gray-900 mb-6">SUMMARY OF KEY POINTS</h2>
          ...
          <section>
            <h2 className="text-2xl font-[500]text-gray-900 mb-6 uppercase ">TABLE OF CONTENTS</h2>
          ...
          <section id="collect">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4">1. WHAT INFORMATION DO WE COLLECT?</h3>
            ...
            <p className="font-[500]mt-6">Information automatically collected</p>
          ...
          <section id="process">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4">2. HOW DO WE PROCESS YOUR INFORMATION?</h3>
          ...
          <section id="legal">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</h3>
          ...
          <section id="share">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h3>
          ...
          <section id="cookies">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4">5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h3>
          ...
          <section id="keep">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4">6. HOW LONG DO WE KEEP YOUR INFORMATION?</h3>
          ...
          <section id="safe">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h3>
          ...
          <section id="minors">
            ...
            <p>We do not knowingly collect, solicit data from, or market to children under 18 years of age or the equivalent age as specified by law in your jurisdiction, nor do we knowingly sell such personal information. By using the Services, you represent that you are at least 18 or the equivalent age as specified by law in your jurisdiction or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age or the equivalent age as specified by law in your jurisdiction has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18 or the equivalent age as specified by law in your jurisdiction, please contact us at <a href="mailto:info@auralearning.co" className="text-primary">info@auralearning.co</a>.</p>
          </section>

          <section id="rights">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4">9. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
            ...
            <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:info@auralearning.co" className="text-primary">info@auralearning.co</a>.</p>
          </section>

          <section id="dnt">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h3>
          ...
          <section id="us-residents">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4">11. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h3>
            ...
            <p className="font-[500]mt-6">Categories of Personal Information We Collect</p>
            ...
            <div className="overflow-x-auto my-8">
              <table className="min-w-full text-sm border border-gray-200">
                ...
                <tbody>
                  <tr>
                    <td className="p-3 border font-medium">A. Identifiers</td>
                    <td className="p-3 border text-gray-500 text-xs">Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name</td>
                    <td className="p-3 border text-center font-bold">NO</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="p-3 border font-medium">B. Personal information as defined in the Ohio Customer Records statute</td>
                    <td className="p-3 border text-gray-500 text-xs">Name, contact information, education, employment, employment history, and financial information</td>
                    <td className="p-3 border text-center font-bold">NO</td>
                  </tr>
                  <tr>
                    <td className="p-3 border font-medium">C. Protected classification characteristics under state or federal law</td>
                    <td className="p-3 border text-gray-500 text-xs">Gender, age, date of birth, race and ethnicity, national origin, marital status, and other demographic data</td>
                    <td className="p-3 border text-center font-bold">NO</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="p-3 border font-medium">D. Commercial information</td>
                    <td className="p-3 border text-gray-500 text-xs">Transaction information, purchase history, financial details, and payment information</td>
                    <td className="p-3 border text-center font-bold">NO</td>
                  </tr>
                  <tr>
                    <td className="p-3 border font-medium">E. Biometric information</td>
                    <td className="p-3 border text-gray-500 text-xs">Fingerprints and voiceprints</td>
                    <td className="p-3 border text-center font-bold">NO</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="p-3 border font-medium">F. Internet or other similar network activity</td>
                    <td className="p-3 border text-gray-500 text-xs">Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements</td>
                    <td className="p-3 border text-center font-bold">NO</td>
                  </tr>
                  <tr>
                    <td className="p-3 border font-medium">G. Geolocation data</td>
                    <td className="p-3 border text-gray-500 text-xs">Device location</td>
                    <td className="p-3 border text-center font-bold">NO</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="p-3 border font-medium">H. Audio, electronic, sensory, or similar information</td>
                    <td className="p-3 border text-gray-500 text-xs">Images and audio, video or call recordings created in connection with our business activities</td>
                    <td className="p-3 border text-center font-bold">NO</td>
                  </tr>
                  <tr>
                    <td className="p-3 border font-medium">I. Professional or employment-related information</td>
                    <td className="p-3 border text-gray-500 text-xs">Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us</td>
                    <td className="p-3 border text-center font-bold">NO</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="p-3 border font-medium">J. Education Information</td>
                    <td className="p-3 border text-gray-500 text-xs">Student records and directory information</td>
                    <td className="p-3 border text-center font-bold">NO</td>
                  </tr>
                  <tr>
                    <td className="p-3 border font-medium">K. Inferences drawn from collected personal information</td>
                    <td className="p-3 border text-gray-500 text-xs">Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics</td>
                    <td className="p-3 border text-center font-bold">NO</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="p-3 border font-medium">L. Sensitive personal Information</td>
                    <td className="p-3 border text-gray-500 text-xs">Social security numbers, driver's license numbers, state ID card, or passport numbers, etc.</td>
                    <td className="p-3 border text-center font-bold">NO</td>
                  </tr>
                </tbody>
              </table>
            ...
            <p className="font-[500]mt-6">Sources of Personal Information</p>
            <p>Learn more about the sources of personal information we collect in the section "WHAT INFORMATION DO WE COLLECT?"</p>

            <p className="font-[500]mt-6">How We Use and Share Personal Information</p>
            ...
            <p className="font-[500]mt-6">Your Rights</p>
            ...
            <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at <a href="mailto:info@auralearning.co" className="text-primary">info@auralearning.co</a>, or by referring to the contact details at the bottom of this document.</p>
            ...
            <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:info@auralearning.co" className="text-primary">info@auralearning.co</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
          </section>

          <section id="updates">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4">12. DO WE MAKE UPDATES TO THIS NOTICE?</h3>
          ...
          <section id="contact">
            ...
            <p>If you have questions or comments about this notice, you may email us at <a href="mailto:info@auralearning.co" className="text-primary font-bold">info@auralearning.co</a> or contact us by post at:</p>
            <p>Email: <a href="mailto:info@auralearning.co" className="text-primary font-bold">info@auralearning.co</a></p>
          </section>

          <section id="review">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3>
