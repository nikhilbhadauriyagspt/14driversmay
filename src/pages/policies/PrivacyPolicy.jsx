        ...
        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-8">
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Visit our website at <a href="https://pixcircuit.co/" className="text-primary hover:text-secondary">https://pixcircuit.co/</a> or any website of ours that links to this Privacy Notice</li>
            ...
            <p>
              <strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:info@pixcircuit.co" className="text-primary">info@pixcircuit.co</a>.
            </p>
          </section>
          ...
          <section id="rights">
            ...
            <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:info@pixcircuit.co" className="text-primary">info@pixcircuit.co</a>.</p>
          </section>
          ...
          <section id="us-residents">
            ...
            <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at <a href="mailto:info@pixcircuit.co" className="text-primary">info@pixcircuit.co</a>, or by referring to the contact details at the bottom of this document.</p>
            ...
            <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:info@pixcircuit.co" className="text-primary">info@pixcircuit.co</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
          </section>
          ...
          <section id="contact">
            ...
            <p>If you have questions or comments about this notice, you may email us at <a href="mailto:info@pixcircuit.co" className="text-primary font-bold">info@pixcircuit.co</a> or contact us by post at:</p>
            <p>Email: <a href="mailto:info@pixcircuit.co" className="text-primary font-bold">info@pixcircuit.co</a></p>
          </section>
