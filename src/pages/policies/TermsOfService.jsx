...
const TermsOfService = () => {
  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-24 font-poppins">
      <Helmet>
        <title>Terms of Service - Fanny Learn Hub</title>
        <meta name="description" content="Official Terms of Service for Fanny Learn Hub. Agreement to our legal terms and conditions." />
        <link rel="canonical" href="https://fannylearnhub.co/terms-of-service" />
      </Helmet>

      <div className="container mx-auto px-4 max-w-5xl">
        <h1 className="text-4xl md:text-5xl font-heading font-[500]text-gray-900 mb-4 uppercase">Terms of Service</h1>
        <p className="text-gray-500 mb-12 italic">Last updated Apr 30, 2026</p>

        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-8">

          <section>
            <h2 className="text-2xl font-[500]text-gray-900 mb-4 uppercase">AGREEMENT TO OUR LEGAL TERMS</h2>

            <p>
              We operate the website <a href="https://fannylearnhub.co/" className="text-primary hover:text-secondary">https://fannylearnhub.co/</a> (the "<strong>Site</strong>"), as well as any other related
            ...
            <p>
              Fanny Learn Hub was founded on the principle that technical documentation should be handled with
            ...
            <p>
              You can contact us by email at <a href="mailto:info@fannylearnhub.co" className="text-primary">info@fannylearnhub.co</a></p>
            <p>
              These Legal Terms constitute a legally binding agreement made between you, whether
              personally or on behalf of an entity ("<strong>you</strong>"), and Fanny Learn Hub, concerning your access to
          ...
          <section id="services">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">1. OUR SERVICES</h3>
          ...
          <section id="intellectual">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">2. INTELLECTUAL PROPERTY RIGHTS</h3>

            <p className="font-[500]mt-4">Our intellectual property</p>
            ...
            <p className="font-[500]mt-4">Your use of our Services</p>
            ...
            <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:info@fannylearnhub.co" className="text-primary">info@fannylearnhub.co</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
            <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
            <p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to use our Services will terminate immediately.</p>

            <p className="font-[500]mt-4">Your submissions</p>
          ...
          <section id="representations">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">3. USER REPRESENTATIONS</h3>
          ...
          <section id="prohibited">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">4. PROHIBITED ACTIVITIES</h3>
          ...
          <section id="contributions">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">5. USER GENERATED CONTRIBUTIONS</h3>
          ...
          <section id="license">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">6. CONTRIBUTION LICENSE</h3>
          ...
          <section id="management">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">7. SERVICES MANAGEMENT</h3>
          ...
          <section id="privacy">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">8. PRIVACY POLICY</h3>
            <p>We care about data privacy and security. Please review our Privacy Policy: <a href="https://fannylearnhub.co/privacy-policy" className="text-primary hover:underline">https://fannylearnhub.co/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
          </section>

          <section id="termination">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">9. TERM AND TERMINATION</h3>
          ...
          <section id="modifications">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">10. MODIFICATIONS AND INTERRUPTIONS</h3>
          ...
          <section id="law">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">11. GOVERNING LAW</h3>
            <p>These Legal Terms and your use of the Services are governed by and construed in accordance with the laws of the State of Oklahoma applicable to agreements made and to be entirely performed within the State of Oklahoma, without regard to its conflict of law principles.</p>
          </section>

          <section id="dispute">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">12. DISPUTE RESOLUTION</h3>
            <p>Any legal action of whatever nature brought by either you or us (collectively, the "Parties" and individually, a "Party") shall be commenced or prosecuted in the state and federal courts located in Oklahoma, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.</p>
          </section>

          <section id="corrections">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">13. CORRECTIONS</h3>
            <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>
          </section>

          <section id="disclaimer">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">14. DISCLAIMER</h3>
          ...
          <section id="liability">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">15. LIMITATIONS OF LIABILITY</h3>
          ...
          <section id="indemnification">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">16. INDEMNIFICATION</h3>
          ...
          <section id="data">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">17. USER DATA</h3>
          ...
          <section id="electronic">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">18. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
          ...
          <section id="miscellaneous">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">19. MISCELLANEOUS</h3>
          ...
          <section id="contact">
            <h3 className="text-xl font-[500]text-gray-900 border-b pb-2 mb-4 uppercase">20. CONTACT US</h3>
            <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:</p>
            <p>Email: <a href="mailto:info@fannylearnhub.co" className="text-primary">info@fannylearnhub.co</a></p>
          </section>
        </div>
      </div>
    </div>
